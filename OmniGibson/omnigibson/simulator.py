...
def _launch_simulator(*args, **kwargs):
    ...
    class Simulator(lazy.isaacsim.core.api.SimulationContext, Serializable):
        ...
        def enable_viewer_camera_teleoperation(self):
            ...
            # Re-entry (e.g. after scene env.reset): clear old subscription or keyboard handlers stack and
            # fight with setup_navigation_view_layout / main viewport, causing camera flicker and odd motion.
            if self._camera_mover is not None:
