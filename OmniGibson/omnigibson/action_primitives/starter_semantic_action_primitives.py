...
m.DEFAULT_COLLISION_ACTIVATION_DISTANCE = 0.025  # 放宽碰撞检测距离，与curobo.py保持一致
m.MAX_PLANNING_ATTEMPTS = 150  # 增加规划尝试次数
m.MAX_IK_FAILURES_BEFORE_RETURN = 80  # 增加IK失败次数限制
